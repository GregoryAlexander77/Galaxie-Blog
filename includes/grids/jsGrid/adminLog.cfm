		...
		$("#<cfoutput>#gridName#</cfoutput>").jsGrid({
			...
			controller: {
				loadData: function (filter) {
					...
					return $.ajax({
						type: "GET",
						url: "<cfoutput>#application.baseUrl#</cfoutput>/common/cfc/ProxyController.cfc?method=getAdminLogForGrid&gridType=jsGrid&csrfToken=<cfoutput>#csrfToken#</cfoutput>", 
						data: filter,
						dataType: "json"
			...
			fields: [
				...
				{ 
					...
					title: "User Agent",
					editing: false,
					width: (pageWidth*(<cfif session.isMobile>30<cfelse>40</cfif>/100)),
					itemTemplate: function(value, item) {
