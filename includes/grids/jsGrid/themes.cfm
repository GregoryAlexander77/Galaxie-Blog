...
<form id="themesGridForm" action="#" method="post" data-role="validator">
	<table align="center" class="k-content tableBorder" width="100%" cellpadding="2" cellspacing="0" border="0">
	  ...
	  <tr height="2px">
		  <td align="left" valign="top" class="border <cfoutput>#thisContentClass#</cfoutput>">
		  </td>
	  </tr>
	  <!-- Form content -->
				...
				updateItem: function(value, item) {
					return $.ajax({
						...
						data: {
							...
							modernThemeStyle: value.ModernThemeStyle,
			...
			fields: [
				...
				{ 
					...
					*/
					...
					width: (pageWidth*(<cfif session.isMobile>25<cfelse>20</cfif>/100)),
				},
				<cfif not session.isMobile>
				{ 
					name: "ModernThemeStyle", 
					type: "checkbox",
					title: 'Modern Theme?',
					editing: true,
