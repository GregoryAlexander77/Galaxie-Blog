...
<head><cfoutput>
	...
	<p>All columns are sortable and most are searchable. To search, enter the search term on top of the column and click the search link at the right of the page. To change the name of a user, click on the row, change the text, and click on the update checkmark on the right of the page. There are extensive user details available by clicking on the user name link.</p>
...
<form id="usersGridForm" action="#" method="post" data-role="validator">
	<!--- Pass the csrfToken --->
	...
	<table align="center" class="k-content tableBorder" width="100%" cellpadding="2" cellspacing="0" border="0">
	  ...
	  <tr valign="middle" height="30px">
		<td align="left" width="75%" class="<cfoutput>#thisContentClass#</cfoutput>">
			<button id="newUser" name="newUser" class="k-button k-primary" type="button" onClick="createAdminInterfaceWindow(7,'', 'addUser');">Create New User</button>
		</td>
	  </tr>
	  <cfsilent>
			...
			fields: [
				{ 
					...
					itemTemplate: function(value, item) {
					  return '<a href="javascript:createAdminInterfaceWindow(7, ' + item.UserId + ', &apos;editUser&apos;);">' + value + '</a>';
					},
