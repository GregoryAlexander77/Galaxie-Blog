...
<!--- Show the delete button in the grid --->
<cfset showDeleteButton = true>
<!---
		...
		$("#<cfoutput>#gridName#</cfoutput>").jsGrid({
			...
			fields: [
				...
				{ 
					...
					title: "Error Message",
					editing: false,
					width: (pageWidth*(<cfif session.isMobile>75<cfelse>60</cfif>/100)),
				},
				...
				{
					type: "control",
					width: (pageWidth*(<cfif session.isMobile>15<cfelse>5</cfif>/100)),
				}
	...
	<script>
		...
		(function(jsGrid, $, undefined) {
			...
			ControlField.prototype = new Field({
				...
				deleteButton: <cfoutput>#showDeleteButton#</cfoutput>,
