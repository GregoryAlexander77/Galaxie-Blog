...
<table align="center" class="k-content fixedPodTable" width="100%" cellpadding="0" cellspacing="0">
	...
	<tr class="#iif(currentRow MOD 2,DE('k-content'),DE('k-alt'))#">
		...
		<a href="#application.blog.makeCategoryLink(categoryid)#" title="#categoryName# RSS" <cfif darkTheme>style="color:whitesmoke"</cfif>>#categoryName# (#entryCount#)</a> [<a href="#application.rootURL#/rss.cfm?mode=full&amp;mode2=cat&amp;catid=#categoryid#" rel="noindex,nofollow" <cfif darkTheme>style="color:whitesmoke"</cfif>>RSS</a>]
		</td>
	</tr>	
	</cfoutput>
</table>
