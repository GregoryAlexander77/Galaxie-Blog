...
<cfmodule template="../../tags/podlayout.cfm" title="#application.resourceBundle.getResource("search")#">
	...
	<p class="center">
	<input type="text" name="search" style="width: 175px;" class="k-textbox k-textbox" /> 
	<input type="submit" value="#application.resourceBundle.getResource("search")#" class="k-button"/></p>
	</form>
  </div>
	</cfoutput>
