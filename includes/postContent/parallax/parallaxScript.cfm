...
<cfset cb01Header = "Introducing Galaxie Blog">
<cfset cb01Text1 = "Galaxie Blog is a free open source ColdFusion based blog.">
<cfset cb01Text2 = "It is intended to be the most beautiful and functional open sourced ColdFusion based blog in the world.">
<cfset cb02Header = "Stunning Mobile Interface...">
<cfset cb02Text1 = "Galaxie Blog is a responsive website that offers nearly identical functionality for both desktop and mobile devices.">
<cfset cb02Text2 = "">
<cfset slide02Header = "Galaxie Blog is Eminently Themeable">
<cfset slide02Text1 = "Galaxie Blog has dozens of professionally designed pre-defined themes.">
<cfset slide02Text2 = "Changing the look and feel of you blog does not require any coding, you can use web based interfaces to perfectly adjust each theme.">
<cfset cb03Header = "Versatile Post Formats...">
<cfset cb03Text1 = "Add podcasts, thumbnails, images, and enclosures. Blog entries support using inline .css, scripts, and HTML.">
<cfset cb03Text2 = "">
<cfset slide03Header = "Add Engaging Content and Special Effects...">
<cfset slide03Text1 = "Includes a HTML5 media player as well as a Flash player to allow users to add various media.">
<cfset slide03Text2 = "Galaxie Blog also has built in support for animations using the <b>Green Sock Animation Platform.</b>">
<cfset cb04Header = "Display Your Code...">
<cfset cb04Text1 = "Easilly display your code by wrapping your posts with 'code' tags. The code will be displayed and will be automatically adjusted to match your theme.">
<cfset cb04Text2 = "">
<cfset slide04Header = "Interact With Your Users...">
<cfset slide04Text1 = "Galaxie Blog allows users to add comments and use their own gravatar.">
<cfset slide04Text2 = "Captcha support and blog moderation capabilities are included.">
<cfset cb05Header = "Share Your Content...">
<cfset cb05Text1 = "Allow readers to share your blog content with built-in social media sharing.">
<cfset cb05Text2 = "Users can subscribe to your blog or subscribe to a selected post. Galaxie Blog also can share your content with various communities via RSS feeds.">
<cfset slide05Header = "Organize And Find Your Posts...">
<cfset slide05Text1 = "Categories and tag support are built-in. You can also associate your blog entries and related posts.">
<cfset slide05Text2 = "Find your posts using a search engine at the top of the site. Posts are also  automatically displayed by date and can be selected using a calendar control.">
<cfset cb06Header = "Optimized for Search Engines">
<cfset cb06Text1 = "Galaxie Blog is SEO friendly and has a 100% google SEO score.">
<cfset cb06Text2 = "">
<cfset slide06Header = "The Future of Galaxie Blog...">
<cfset slide06Text1 = "I intend using Galaxie Blog for my own personal blog, and it is a key component of my own personal portfolio.">
<cfset slide06Text2 = "I am adding capabilities to use a rich editor within a mobile interface to quickly share my personal photography while out in the field.">
	
<!--- Content block gradients. --->
<cfset contentBlock1Gradient = "blueGradient">
<cfset contentBlock2Gradient = "burntOrangeGradient">
<cfset contentBlock3Gradient = "greenGradient">
<cfset contentBlock4Gradient = "blueGradient">
<cfset contentBlock5Gradient = "burntOrangeGradient">
<cfset contentBlock6Gradient = "greenGradient">
...
<cfset parallaxDividerColor = "8F542F">
	
<!--- Background images --->
<cfset slide02BgImage = "/images/background/gregoryAlexander/blog/yellowStoneRedMedHigh.jpg">
<cfset slide03BgImage = "/images/background/gregoryAlexander/blog/zionValleyMedHigh.jpg">
<cfset slide04BgImage = "/images/background/gregoryAlexander/blog/staircaseMedHigh.jpg">
<cfset slide05BgImage = "/images/background/gregoryAlexander/blog/weepingRockFlippedLowRes.jpg">
<cfset slide06BgImage = "/images/background/gregoryAlexander/bandonSunsetLowRes.jpg">
	...
	<div class="footer-container">
		<footer>
			...
			<ul class="blogFeatures">
			  ...
			  <li>Compliant. Attained 100% Google lighthouse scores for 3 out of 4 categories</li>
			  <li>Galaxie Blog lazy loads resources and media to improve performance</li>
			  <li>To mimimize network bandwidth, Galaxie Blog will only render the image once it comes into the user's viewport</li>
			  <li>Delivers webp images if both the client and the server support the new webp format</li>
