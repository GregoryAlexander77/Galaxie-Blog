...
<input type="text" name="dsn" class="required k-textbox" /><br/>
<label>Database Type:</label> 
<select name="dbtype">
<cfloop item="dbtype" collection="#application.dbtypes#">
	<cfoutput><option value="#dbtype#" <cfif dbtype eq 'MSSQL'>selected</cfif>>#application.dbtypes[dbtype]#</option></cfoutput>
</cfloop>
</select>
<br/>
<label>Username:</label> 
<input type="text" name="dsnusername" class="k-textbox" />
<br/>
<label>Password:</label> 
<input type="text" name="dsnpassword" class="k-textbox" />
<br/>
</fieldset>
			<fieldset>
				...
				<tr>
					...
					<td><input type="text" name="saltKeySize" value="256" class="k-textbox" /></td>
				</tr>
				<tr>
...
<input type="submit" name="submit" value="Verify and Continue" class="k-button" />
</form>
