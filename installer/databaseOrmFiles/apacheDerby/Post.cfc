<cfcomponent displayName="Post" persistent="true" table="Post" output="no" hint="ORM logic for the new Post table">
	...
	<!--- The following 6 items are configured for Apache Derby. Change these depending upon your db --->
	<cfproperty name="JsonLd" ormtype="clob" default="">
	<cfproperty name="PostHeader" ormtype="clob" default="">
	<cfproperty name="CSS" ormtype="clob" default="">
	<cfproperty name="JavaScript" ormtype="clob" default="">
	<cfproperty name="Body" ormtype="clob" default="">
