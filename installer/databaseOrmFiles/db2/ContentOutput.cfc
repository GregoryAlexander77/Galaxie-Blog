<cfcomponent displayName="ContentOutput" persistent="true" table="ContentOutput" output="no" hint="ORM logic for the new ContentOutput table. This table will store the all of the various content by certain conditions, such as if the device is mobile.">
	...
	<!--- These two columns are configured for Db2 Server. Manually change the varchar(32764) property if you use another db --->
	<cfproperty name="ContentOutput" ormtype="string" sqltype="varchar(32764)" default="">
	<cfproperty name="ContentOutputMobile" ormtype="string" sqltype="varchar(32764)" default="">
