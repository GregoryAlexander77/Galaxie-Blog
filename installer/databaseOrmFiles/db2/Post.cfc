<cfcomponent displayName="Post" persistent="true" table="Post" output="no" hint="ORM logic for the new Post table">
	...
	<!--- The following 6 items are configured for DB2. Change these depending upon your db --->
	...
	<cfproperty name="CSS" ormtype="string" sqltype="varchar(32764)" default="">
	<cfproperty name="JavaScript" ormtype="string" sqltype="varchar(32764)" default="">
	<cfproperty name="Body" ormtype="string" sqltype="varchar(32764)" default="">
	<cfproperty name="MoreBody" ormtype="string" sqltype="varchar(32764)" default="">
