<cfcomponent displayName="Comment" persistent="true" table="Comment" output="no" hint="ORM logic for the new Comment table">
	...
	<!--- This is configured for DB2 Server. Manually change the varchar(32764) property if you use another db --->
	<cfproperty name="Comment" ormtype="string" sqltype="varchar(32764)" default="">
