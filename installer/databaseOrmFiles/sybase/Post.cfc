<cfcomponent displayName="Post" persistent="true" table="Post" output="no" hint="ORM logic for the new Post table">
	...
	<!--- The following 6 items are configured for Sybase. Change these depending upon your db --->
	<cfproperty name="JsonLd" ormtype="long" default="">
	<cfproperty name="PostHeader" ormtype="long" default="">
	<cfproperty name="CSS" ormtype="long" default="">
	<cfproperty name="JavaScript" ormtype="long" default="">
