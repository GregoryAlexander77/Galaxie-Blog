...
<cfif structKeyExists(form, "runscripts")>
	...
	<input type="submit" value="Move on to the settings." class="k-textbox" />
	</form>
...
<cfelseif session.dbtype is "ORACLE">
	...
	<p>
	Sorry, you've selected Oracle as your DB type. I don't currently support setting that type of database help. Please email me (gregory@gregoryalexander.com) if you want to help add that functionality.
	</p>
...
<cfelse>
	...
	<form  method="post">
	<input type="submit" name="runscripts" value="Yes, set up my database please."  class="k-button" />
	</form>

	<form action="step4_settings.cfm" method="post">
	<input type="submit" value="No, move on to the settings."  class="k-button" />
	</form>
