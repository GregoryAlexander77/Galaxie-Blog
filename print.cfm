...
<cfdocument format="pdf">
	...
	<div class="byline">#getResourceBundle("postedat")# : #application.localeUtils.dateLocaleFormat(entry.posted)# #application.localeUtils.timeLocaleFormat(entry.posted)# 
		<cfif len(entry.name)>| #getResourceBundle("postedby")# : #entry.name#</cfif><br />
		#getResourceBundle("relatedcategories")#:
