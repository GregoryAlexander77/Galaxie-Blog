...
<cfif structKeyExists(url, "cferrordump")>
	<cfset currentPathDump = getDirectoryFromPath(getCurrentTemplatePath()) & form.dump/>
	<cffile action="Write" file="#currentPathDump#" output="#form.log#" addNewLine="no">
	<cfset form.search = url.search>
</cfif>
