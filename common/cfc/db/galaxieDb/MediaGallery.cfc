<cfcomponent displayName="MediaGallery" persistent="true" table="MediaGallery" output="no" hint="ORM logic for the new Gallery table. This table will have multiple records for each Post. Each record will be an individual fancy box thing.">
