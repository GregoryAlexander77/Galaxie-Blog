<cfcomponent displayName="ThemeSetting" persistent="true" table="ThemeSetting" output="no" hint="ORM logic for the new ThemeSetting table">
	...
	<cfproperty name="SiteOpacity" ormtype="string" default="99" length="10">
	<!--- Header HTML --->
	<cfproperty name="CustomHeaderHtml" ormtype="string" length="5000" default="">
	<cfproperty name="CustomHeaderHtmlApplyAcrossThemes" ormtype="boolean" default="false">
	<!--- FavIcons --->
	<cfproperty name="FavIconHtml" ormtype="string" length="2000" default="">
	<cfproperty name="FavIconHtmlApplyAcrossThemes" ormtype="boolean" default="false">
	...
	<!--- Tail end scripts --->
	<cfproperty name="TailEndScripts" ormtype="string" length="5000" default="">
	<cfproperty name="TailEndScriptsApplyAcrossThemes" ormtype="boolean" default="false">
