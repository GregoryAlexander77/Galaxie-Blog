<cfcomponent displayname="Renderer" hint="Functions to render client side code." name="Renderer">
	...
	<cffunction name="renderScrollWidgetPosts" returntype="string" output="false"
			hint="This will render the posts wihin a scroll widget. It is used for popular and related posts.">
