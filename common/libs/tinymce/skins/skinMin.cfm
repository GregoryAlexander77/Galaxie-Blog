<cfset lowerToolBarIconColor = "FFF">
<cfset toolBarButtonHoverColor = "FFF">
<cfset toolBarButtonSelect = "a9a9a9">
<cfset topMenuBarBgColor = "363940"><!---Dark color is 363940--->
<cfset topMenuBarTextColor = "363940"><!---Dark color is 363940--->
<cfset lowerMenuBarTextColor = "363940">
...
.tox {
  ...
  color: #<cfoutput>#toolBarButtonHoverColor#</cfoutput>;
  cursor: auto;
...
.tox .tox-dialog__body-content .accessibility-issue--info .accessibility-issue__description {
  background-color: rgba(16, 196, 178, .1);
  border-color: #10c4b2;
  color: #<cfoutput>#toolBarButtonHoverColor#</cfoutput>
}
...
.tox .tox-dialog__body-content .accessibility-issue--error .accessibility-issue__description {
  background-color: rgba(219, 66, 64, .1);
  border-color: rgba(219, 66, 64, .4);
  color: #<cfoutput>#toolBarButtonHoverColor#</cfoutput>
}
...
.tox .tox-dialog__body-content .accessibility-issue--success .accessibility-issue__description {
  background-color: rgba(43, 137, 60, .1);
  border-color: rgba(43, 137, 60, .4);
  color: #<cfoutput>#toolBarButtonHoverColor#</cfoutput>
}
...
.tox .tox-collection--list .tox-collection__item--active {
  background-color: #<cfoutput>#toolBarButtonSelect#</cfoutput>
}
...
.tox .tox-collection__item-caret svg {
  fill: #<cfoutput>#toolBarButtonHoverColor#</cfoutput>
}
...
.tox .tox-swatches__picker-btn:hover {
  background: #<cfoutput>#toolBarButtonSelect#</cfoutput>
}
...
.tox .tox-insert-table-picker .tox-insert-table-picker__selected {
  background-color: rgba(16, 196, 178, .5);
  border-color: rgba(16, 196, 178, .5)
}
...
.tox .tox-menubar {
  background: url("data:image/svg+xml;charset=utf8,%3Csvg height='39px' viewBox='0 0 40 39px' width='40' xmlns='http://www.w3.org/2000/svg'%3E%3Crect x='0' y='38px' width='100' height='1' fill='%235a5655'/%3E%3C/svg%3E") left 0 top 0 #<cfoutput>#topMenuBarBgColor#</cfoutput>;
  background-color: #<cfoutput>#topMenuBarBgColor#</cfoutput>;
  display: flex;
  flex: 0 0 auto;
  flex-shrink: 0;
  flex-wrap: wrap;
...
.tox .tox-mbtn__select-label {
  ...
  font-weight: 400;
  margin: 0 4px;
  color: #<cfoutput>#topMenuBarTextColor#</cfoutput>;
}
...
.tox .tox-pop.tox-pop--left::before {
  border-color: transparent #5a5655 transparent transparent;
  border-width: 10px;
  margin-left: -19px
}
...
.tox .tox-pop.tox-pop--right::before {
  border-color: transparent transparent transparent #5a5655;
  border-width: 10px;
  margin-left: -1px
}
...
.tox .tox-tbtn svg {
  display: block;
  fill: #<cfoutput>#lowerToolBarIconColor#</cfoutput>
}
...
.tox .tox-tbtn--bespoke .tox-tbtn__select-label {
  ...
  white-space: nowrap;
  width: 7em;
  color: #<cfoutput>#lowerMenuBarTextColor#</cfoutput>;
}
...
.tox .tox-split-button:hover {
  box-shadow: 0 0 0 1px #<cfoutput>#toolBarButtonSelect#</cfoutput> inset
}
...
.tox .tox-toolbar__group {
  ...
  margin: 0 0;
  padding: 0 4px 0 4px;
  <cfoutput>#toolBarButtonHoverColor#</cfoutput>
}
...
.tox .tox-tooltip__body {
  background-color: #<cfoutput>#toolBarButtonHoverColor#</cfoutput>;
  border-radius: 3px;
...
.tox .tox-tooltip--down .tox-tooltip__arrow {
  ...
  border-top: 8px solid #<cfoutput>#toolBarButtonHoverColor#</cfoutput>;
  bottom: 0;
  left: 50%;
  position: absolute;
...
.tox .tox-tooltip--up .tox-tooltip__arrow {
  border-bottom: 8px solid #<cfoutput>#toolBarButtonHoverColor#</cfoutput>;
  border-left: 8px solid transparent;
  border-right: 8px solid transparent;
  left: 50%;
  position: absolute;
...
.tox .tox-tooltip--right .tox-tooltip__arrow {
  ...
  border-left: 8px solid #<cfoutput>#toolBarButtonHoverColor#</cfoutput>;
...
.tox .tox-tooltip--left .tox-tooltip__arrow {
  border-bottom: 8px solid transparent;
  border-right: 8px solid #<cfoutput>#toolBarButtonHoverColor#</cfoutput>;
  border-top: 8px solid transparent;
  left: 0;
  position: absolute;
  top: 50%;
