...
<button type="button" class="k-button k-primary" style="#kendoButtonStyle#">
	<i class="fas fa-file-download" style="color:whitesmoke"></i>&nbsp;&nbsp;<a href="http://www.gregoryalexander.com/blog/dist/gregorysBlog.zip" style="color:whitesmoke" download>Download</a>
</button>
...
<p>Version 1.1 July 14th, 2019.</p>
