...
<p><b>Gregory’s Blog</b> is intended to be the most beautiful and functional open sourced ColdFusion based blog in the world. While I can’t go toe to toe with Wordpress functionality, I believe that Gregory’s Blog competes with Wordpress in core functionality, especially with its abundant theme related features. This blog was built from the ground up to be eminently themeable. Gregory's Blog is a responsive web application, and should be fully functional and work on any modern device: desktop: tablet: and mobile. With a limited amount of time and knowledge, a user can change the background and logo images, set the various container widths, opacities, and even skin and share their own personal themes. I have also developed a dozen or so professionally designed pre-defined themes.</p>
...
<p><b>License</b></p>
<p>Gregory’s Blog, and its associated software, is governed by the <a href="https://www.apache.org/licenses/LICENSE-2.0.html">Apache 2.0 license</a>. 
...
<button type="button" class="k-button k-primary" style="#kendoButtonStyle#">
	<i class="fas fa-file-download" style="color:whitesmoke"></i>&nbsp;&nbsp;<a href="http://www.gregoryalexander.com/blog/dist/gregorysBlog.zip" style="color:whitesmoke" download>Download ZIP</a>
</button>
		
<button type="button" class="k-button k-primary" style="#kendoButtonStyle#">
	<i class="fab fa-github" style="color:whitesmoke"></i>&nbsp;&nbsp;<a href="https://github.com/GregoryAlexander77/gregorysBlog" style="color:whitesmoke" download>Github Project</a>
</button>
...
<p>Version <cfoutput>#application.blog.getVersion()#</cfoutput> July 25th, 2019.</p>
