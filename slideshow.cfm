...
<cfmodule template="tags/layout.cfm" title="#title#">
	...
	<cfif url.slide gt 1>
	<a href="#application.rooturl#/slideshow.cfm/#slideshowdir#?slide=#decrementValue(url.slide)#" class="k-content">Previous</a>
	<cfelse>
	Previous
	</cfif> 
	~ 
	<cfif url.slide lt images.recordCount>
	<a href="#application.rooturl#/slideshow.cfm/#slideshowdir#?slide=#incrementValue(url.slide)#" class="k-content">Next</a>
	<cfelse>
	Next
	</cfif> 
