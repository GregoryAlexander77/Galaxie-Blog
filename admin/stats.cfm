...
<!---
	...
	History      : reset for 5.0
				 ...
				 : Gregory included the resource bundle.
	Purpose		 : Stats
--->
	
<!--- Gregory included the resource bundle (it is missiong due to the application.cfm to application.cfc)--->
...
<cfmodule template="../tags/adminlayout.cfm" title="Stats">
	...
	<div id="statstabs">
		...
		<ul>
			<li><a href="##generalstats">#getResourceBundle("generalstats")#</a></li>
			<li><a href="##topviews">#getResourceBundle("topviews")#</a></li>
			<li><a href="##categorystats">#getResourceBundle("categorystats")#</a></li>
			<li><a href="##topentriesbycomments">#getResourceBundle("topentriesbycomments")#</a></li>
			<li><a href="##topcategoriesbycomments">#getResourceBundle("topcategoriesbycomments")#</a></li>
			<li><a href="##topsearchterms">#getResourceBundle("topsearchterms")#</a></li>
			<li><a href="##topcommenters">#getResourceBundle("topcommenters")#</a></li>
		</ul>
		...
		<div id="generalstats">
			...
			<table border="1" width="100%">
				...
				<tr>
					<td width="50%">#getResourceBundle("totalsubscribers")#:</td>
			...
			<table border="1" width="100%">
				<cfloop query="topCommentedCategories">
					...
					<tr>
						...
						<td align="right">#commentCount# (#getResourceBundle("avgcommentperentry")#: #avg#)</td>
					</tr>
				</cfloop>
			</table>
