    ...
    <script>
		...
		.on('upload-success', (file, response) => {
			...
			<!--- Dump in the font Id's to the hidden fontId list and separate the values with underscores. We will use a listGetAt function on the back end to extract the Id's If there are any fontIds in the form, separtate the new Id with an underscore. --->
