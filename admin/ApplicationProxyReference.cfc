<cfcomponent extends="blog.Application"><!---Examples: extends="blog.Application" if in the blog is in a 'blog' subfolder, extends="Proxy" if the Application.cfc is in the root directory. --->
